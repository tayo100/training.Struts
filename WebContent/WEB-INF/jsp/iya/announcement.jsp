	...
	<table class="inputform">
		...
		<tr>
			...
			<td><s:url namespace="/ajax" action="public-ajax" id="xx" /> <iita:autocompleter
				cssClass="organization" name="sponsor"
		...
		<tr>
			...
			<td><s:url namespace="/ajax" action="public-ajax" id="xxx" /> <iita:autocompleter
				cssClass="organization" name="organizer"
			...
			<table>
				...
				<s:if test="announcement.trainingObjectives.size()>0">
					<s:iterator value="announcement.trainingObjectives" status="status">
						...
						<tr>
							<td><s:textfield
								name="announcement.trainingObjectives[%{trainingObj}].objective"
								value="%{objective}" /></td>
						</tr>
					</s:iterator>
				</s:if>
				<tr>
					<td><s:textfield
						name="announcement.trainingObjectives[%{announcement==null || announcement.trainingObjectives==null ? 0 : announcement.trainingObjectives.size}].objective"
						value="%{objective}" /></td>
				</tr>
				<tr>
					<td><a
				...
				<s:if test="announcement.trainingLocations.size()>0">
					<s:iterator value="announcement.trainingLocations" status="status">
						...
						<tr>
							...
							<td><s:textfield
								name="announcement.trainingLocations[%{locIndex}].venue"
								value="%{venue}" /></td>
							<td><iita:datepicker
								name="announcement.trainingLocations[%{locIndex}].startDate"
								value="%{startDate}" cssClass="mthyrpicker" /></td>
							<td><iita:datepicker
								name="announcement.trainingLocations[%{locIndex}].endDate"
								value="%{endDate}" cssClass="mthyrpicker" /></td>
						</tr>
					</s:iterator>
				</s:if>
				<tr>
					<td><s:select emptyOption=""
						...
						value="%{country}" headerKey="" headerValue="--Select country--" /></td>
					<td><s:textfield
						name="announcement.trainingLocations[%{announcement==null || announcement.trainingLocations==null ? 0 : announcement.trainingLocations.size}].venue"
						value="%{venue}" /></td>
					<td><iita:datepicker
						name="announcement.trainingLocations[%{announcement==null || announcement.trainingLocations==null ? 0 : announcement.trainingLocations.size}].startDate"
						value="" cssClass="mthyrpicker" /></td>
					<td><iita:datepicker
						name="announcement.trainingLocations[%{announcement==null || announcement.trainingLocations==null ? 0 : announcement.trainingLocations.size}].endDate"
						value="" cssClass="mthyrpicker" /></td>
				</tr>
				<tr>
					<td colspan="4"><a
			...
			<table>
				...
				<s:if test="announcement.facilitators.size()>0">
					<s:iterator value="announcement.facilitators" status="status">
						...
						<tr>
							<td><s:textfield
								name="announcement.facilitators[%{trainerIndex}].names"
								value="%{person==null ? names : person.fullName}" /></td>
							<td><s:textfield
								name="announcement.facilitators[%{trainerIndex}].email"
								value="%{email}" /></td>
							<td><s:select
								name="announcement.facilitators[%{trainerIndex}].type"
								value="%{type}"
								list="@org.iita.trainingunit.model.Trainer$TrainerType@values()" /></td>
							<td><s:textarea
								name="announcement.facilitators[%{trainerIndex}].notes"
								value="%{notes}" /></td>
						</tr>
					</s:iterator>
				</s:if>
				<tr>
					<td><s:textfield
						name="announcement.facilitators[%{announcement==null || announcement.facilitators==null ? 0 : announcement.facilitators.size}].names"
						value="%{names}" /></td>
					<td><s:textfield
						name="announcement.facilitators[%{announcement==null || announcement.facilitators==null ? 0 : announcement.facilitators.size}].email"
						value="%{email}" /></td>
					<td><s:select
						name="announcement.facilitators[%{announcement==null || announcement.facilitators==null ? 0 : announcement.facilitators.size}].type"
						value="%{type}"
						list="@org.iita.trainingunit.model.Trainer$TrainerType@values()" /></td>
					<td><s:textarea
						name="announcement.facilitators[%{announcement==null || announcement.facilitators==null ? 0 : announcement.facilitators.size}].notes"
						value="%{notes}" /></td>
				</tr>
				<tr>
					<td><a
		...
		<tr>
			<td></td>
			<td><s:if test="announcement==null || announcement.id<=0">
