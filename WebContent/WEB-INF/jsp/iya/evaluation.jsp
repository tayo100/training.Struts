...
<a href="<s:url namespace="/iya" action="evaluations" />">All Evaluations</a> 
</div>

<h2>Appraise <s:property value="registration.iyaTrainingAnnouncement.trainingCourse" /> </h2>
