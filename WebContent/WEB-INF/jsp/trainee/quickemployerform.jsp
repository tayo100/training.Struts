...
<s:form action="add-trainee-eduinfo" method="post">
	...
	<table class="inputform">
		...
		<tr>
			<td>Degree:</td>
			<td><s:textfield name="traineeEduInfo.location" /></td>
		</tr>
		<!-- 
		<tr>
			<td>Degree Award Date:</td>
			<td><iita:datepicker name="traineeEduInfo.degreeAwardDate" format="dd/MM/yyyy" /></td>
		</tr> -->
		<tr>
			<td>University:</td>
			<td><s:textfield name="traineeEduInfo.university" /></td>
		</tr>
		<tr>
			<td>University Address:</td>
			<td><s:textfield name="traineeEduInfo.universityAddress" /></td>
		</tr>
		<tr>
			<td></td>
