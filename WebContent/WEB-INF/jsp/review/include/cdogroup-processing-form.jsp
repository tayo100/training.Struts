	...
	<table class="inputform">
		...
		<tbody>
			<tr>
				...
				<td><s:radio id="rating" value="%{application.internalApprovals.rating}" name="application.internalApprovals.rating" 
			                	list="@org.iita.trainingunit.applications.model.InternalApprovals$RATING@values()" 
			                	listValue="%{getText('application.rating.'+toString())}" /></td>
			</tr>
			...
			<tr>
				<td>Total Budget</td>
				<td><s:textfield name="internalApprovals.totalBudget" value="%{application.internalApprovals.totalBudget}" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Remarks</td>
				<td><s:textarea name="internalApprovals.remarks" value="%{application.internalApprovals.remarks}" /></td>
			</tr>
			<tr>
				<td />
