...
<h4>Current Education and Training</h4>
	<div>
	    <table id="educationTablex" class="table">
	    <colgroup>
			<col />
			<col />
			<col />
		...
		<tr>
			...
			<tr>
				<td><s:textfield cssClass="form-control" name="cdoBioData.educationAndTraining[0].nameOfInstitution" value="%{cdoBioData.educationAndTraining[0].nameOfInstitution}" /></td>
				<td><s:select cssClass="form-control" emptyOption="true" value="%{cdoBioData.educationAndTraining[0].country}" name="cdoBioData.educationAndTraining[0].country" 
...
,'Women`s Studies':'Women`s Studies'}" 
				...
				<td><s:select cssClass="form-control" emptyOption="" 
					name="cdoBioData.educationAndTraining[0].certificateObtained" 
					list="#{'MSc.':'Master of Science',
					'PhD':'Doctor of Philosopy'}"  
					value="%{cdoBioData.educationAndTraining[0].certificateObtained}" headerKey="" headerValue="--Select certificate obtained--" /></td>
                <td>
                <s:textfield name="cdoBioData.educationAndTraining[0].startMonthYearOfCertification" value="%{cdoBioData.educationAndTraining[0].startMonthYearOfCertification}" cssClass="mthyrpicker form-control" /></td>
                <td><s:textfield name="cdoBioData.educationAndTraining[0].stopMonthYearOfCertification" value="%{cdoBioData.educationAndTraining[0].stopMonthYearOfCertification}" cssClass="mthyrpicker form-control" /></td>
            </tr>
	    </table>
	</div>
