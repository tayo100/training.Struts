...
<s:form namespace="/iya" action="announcement/save-edit" method="post">
	...
	<table class="inputform">
		...
		<tr>
			...
			<td>
				...
				id="announcement.sponsor" submitTextTo="sponsor" listKey="title" listValue="title" url="%{xx}" method="autocompleteOrganization" displayValue="%{announcement.sponsor}" />
			</td>
		</tr>
		<tr>
			<td>Organizer:</td>
			<td>
				...
				id="announcement.organizer" listKey="title" listValue="title" url="%{xxx}" method="autocompleteOrganization" submitTextTo="organizer" displayValue="%{announcement.organizer}" />
			</td>
		</tr>
		...
		<tr>
			<td></td>
			<td><s:submit value="Update" cssClass="btn btn-warning" onclick="javascript: return confirm('Are you sure you want to update this record?');" /></td>
		</tr>
	</table>
</s:form>