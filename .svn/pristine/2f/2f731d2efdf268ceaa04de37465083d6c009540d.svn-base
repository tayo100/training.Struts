...
<body>
<p>Attn: CDO Bio-data Registration Submission</p> 

<p>Registration submission for ${announcement.title} in ${announcement.type} training announcement received.</p>

<p>Below is a copy of submitted personal information registration.</p>
