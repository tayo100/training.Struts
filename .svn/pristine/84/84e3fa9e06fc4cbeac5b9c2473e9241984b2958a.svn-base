...
<s:form action="contact!updateContact" method="post">
	...
	<s:hidden name="type" value="org.iita.crm.model.MobileContact" />
	<table class="inputform">
		...
		<tr>
			<td>MobileNo:</td>
			<td><s:textfield name="contact.mobileNumber"></s:textfield></td>
		</tr>
		<tr>
			<td></td>
			<td><s:submit value="Add Mobile Number" /></td>
		</tr>
	</table>
</s:form>