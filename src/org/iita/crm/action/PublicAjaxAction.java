...
public class PublicAjaxAction {
	 ...
	 * 
	 */
	public PublicAjaxAction(CoreCRMService coreCrmService, IyaService iyaService) {
	...
	@SMDMethod
	public List<IYATrainingAnnouncement> autocompleteIyaAnnouncement(String text) throws SearchException {
		return this.iyaService.autocompleteIyaAnnouncement(text, 10);
	}
	...
	/**
	 * @param iyaService the iyaService to set
	 */
	public void setIyaService(IyaService iyaService) {
		this.iyaService = iyaService;
	}

	/**
	 * @return the iyaService
	 */
	public IyaService getIyaService() {
		return iyaService;
	}
}
